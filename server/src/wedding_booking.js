...
const WEDDING_ROOMS = {
  wedding_small: {
    ...
    shortLabel: "Klein",
    guestSlots: 4,
    capacity: 6, // Brautpaar + 4 Gäste
    totalCost: 0,
    perPerson: 0,
    imageUrl: "/luv/wedding-small-room.png",
    blurb: "Intim: 4 Gäste (6 Plätze inkl. Brautpaar).",
  },
  wedding: {
    id: "wedding",
    name: "Kapelle",
    shortLabel: "Kapelle",
    guestSlots: 6,
    capacity: 8, // Brautpaar + 6 Gäste
    totalCost: 100,
    perPerson: 50,
    imageUrl: "/luv/wedding-chapel-room.png",
    blurb: "Klassische Kapelle: 6 Gäste (8 Plätze inkl. Brautpaar).",
  },
  wedding_grand: {
    id: "wedding_grand",
    name: "Prunksaal",
    shortLabel: "Prunk",
    guestSlots: 8,
    capacity: 10, // Brautpaar + 8 Gäste
    totalCost: 250,
    perPerson: 125,
    imageUrl: "/luv/wedding-grand-room.png",
    blurb: "Prunkvoller Saal: 8 Gäste (10 Plätze inkl. Brautpaar).",
  },
  wedding_island: {
    id: "wedding_island",
    name: "Insel",
    ...
    blurb: "Trauminsel im Wasser: 8 Gäste (10 Plätze inkl. Brautpaar).",
  },
};
