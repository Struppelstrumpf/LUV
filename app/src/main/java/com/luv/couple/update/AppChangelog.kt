...
object AppChangelog {
    ...
    val entries: List<Entry> = listOf(
        ...
        Entry(
            "2.2.167",
            listOf(
                "Erfolge und Tagesbelohnung lassen sich wieder sofort abholen",
            )
        ),
        Entry(
            "2.2.166",
        ...
        Entry(
            "2.2.163",
            listOf(
                "Home zeigt Partner-Slots sofort; Sozial/Events laden gezielt beim Tippen",
            )
        ),
        Entry(
            "2.2.162",
            listOf(
                "Start: zuerst Lobbys + Home, danach Markt/Freunde — fühlt sich schneller an",
            )
        ),
        Entry(
            "2.2.161",
        ...
        Entry(
            "2.2.158",
            listOf(
                "Start schneller: Lobbys verbinden im Hintergrund, kein langes Warten mehr",
            )
        ),
        Entry(
            "2.2.157",
            listOf(
                "App läuft flüssiger; Sozial mit Aktualisieren-Button; Anfragen alle paar Minuten",
            )
        ),
        Entry(
            "2.2.156",
        ...
        Entry(
            "2.2.147",
            listOf(
                "Kleine Trauung: Kapellen-Look mit 4 Stühlen",
            )
        ),
        Entry(
            "2.2.146",
        ...
        Entry(
            "2.2.143",
            listOf(
                "Hochzeit buchen: Geldbäume, Raumwahl (klein/Kapelle/Prunk), gemeinsame Abbuchung",
                "Extra-Gästeplätze +25 Coins bis Cap 10; Geldbäume nur für Gäste",
            )
        ),
        Entry(
            "2.2.142",
        ...
        Entry(
            "2.2.140",
            listOf(
                "Hochzeit-Lobby: Partner sieht die Phase sofort nach dem Öffnen",
                "Kapelle: Ambient-Musik immer, Music-Box wenn beide am Altar",
                "Menü: weiße Idle-Partikel etwas schneller",
            )
        ),
        Entry(
            "2.2.139",
        ...
        Entry(
            ...
            listOf(
                ...
                "Home-Nachrichten ruhiger — Verlobung weg, nur seltene Erfolge",
                "Kapellen-Musik startet erst wenn beide am Altar stehen",
            )
        ),
        Entry(
            "2.2.137",
